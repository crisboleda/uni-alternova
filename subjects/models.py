...
class SubjectStatus(models.Model):
    ...
    code_name = models.CharField(
        max_length=30, verbose_name=("code name"), blank=True
    )
...
class Subject(models.Model):
    ...
    required_subjects = models.ManyToManyField("subjects.Subject", verbose_name=("required subjects"))
    name = models.CharField(
        verbose_name=("subject name"), max_length=80, blank=True
    )
